...
function AppShell() {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-3xl flex-col px-4 pb-28 pt-4 sm:px-6">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-slate-200 bg-white/90 px-3 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-2 shadow-sm shadow-slate-200/70 backdrop-blur-xl">
